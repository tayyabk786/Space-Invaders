...
def start_game():
    ...
    def game_over_text():
        ...
        # Buttons
        class Button:
            def __init__(self, y, x, width, height, text, action, text_colour=BUTTON_TEXT_COLOUR):
            ...
            def draw(self):
                ...
                text_surface = BUTTON_FONT.render(self.text, True, self.text_colour)  
            ...
            button3 = Button(250, 80, 285, 100, "GAME OVER", "quit", GAME_OVER_COLOUR)  # Game over colour red
